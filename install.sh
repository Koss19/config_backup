...
#install packages
PACKAGES="bash-completion neofetch alacritty kitty conky polybar ranger screen scrot vim i3-gaps i3lock-color i3exit arandr xautolock rofi numlock setxkbmap compton nitrogen i3-scrot"
